...
class __TwigTemplate_b63570a68bb7890f47164d57da615108 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 28
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->attachLibrary("bootstrap_barrio/alerts"), "html", null, true);
        yield "
...
$context["type"] == "info")) ? ("alert-info") : (""))];
            ...
            yield "\" ";
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, $this->extensions['Drupal\Core\Template\TwigExtension']->withoutFilter($this->sandbox->ensureToStringAllowed(($context["attributes"] ?? null), 66, $this->source), "role", "aria-label"), "addClass", [($context["classes"] ?? null)], "method", false, false, true, 66), "setAttribute", ["data-drupal-selector", "messages"], "method", false, false, true, 66), "setAttribute", ["role", (($__internal_compile_1 = ($context["role"] ?? null)) && is_array($__internal_compile_1) || $__internal_compile_1 instanceof ArrayAccess ? ($__internal_compile_1[$context["type"]] ?? null) : null)], "method", false, false, true, 66), 66, $this->source), "html", null, true);
            yield ">
    ";
            // line 67
    ...
    ";
      ...
      ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["message"]) {
                // line 81
                yield "        ";
                if (CoreExtension::getAttribute($this->env, $this->source, $context["loop"], "last", [], "any", false, false, true, 81)) {
                    // line 82
                    yield "          ";
                    yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($context["message"], 82, $this->source), "html", null, true);
                    yield "
        ";
                } else {
                    // line 84
                    yield "          ";
                    yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($context["message"], 84, $this->source), "html", null, true);
                    yield "
      <hr>
        ";
                }
...
";
        $this->env->getExtension('\Drupal\Core\Template\TwigExtension')
            ->checkDeprecations($context, ["message_list", "status_headings", "attributes", "title_ids", "loop"]);        return; yield '';
    }
    ...
    {
        return array (  170 => 92,  161 => 88,  147 => 87,  140 => 84,  134 => 82,  131 => 81,  114 => 80,  109 => 78,  105 => 77,  102 => 76,  98 => 74,  96 => 73,  93 => 72,  91 => 71,  88 => 70,  86 => 69,  83 => 68,  81 => 67,  74 => 66,  72 => 59,  70 => 58,  68 => 55,  67 => 54,  66 => 53,  65 => 52,  64 => 45,  62 => 44,  58 => 43,  40 => 28,);
    }
